        ...
        <div className="flex flex-col h-full justify-between cursor-default">
          ...
          {popupType === "help" && (
            <div className="flex flex-col items-center self-center text-center w-5/6">
              <p className="pb-3">
                Im <b>Wegweiser.UX-für-KI Quiz</b> kannst du dich selbstständig
                zu den Themen <b className="pink">{topics[0]}</b>,{" "}
                <b className="lila">{topics[1]}</b> und{" "}
                <b className="türkis">{topics[2]}</b> testen. Zu jedem Thema
                erhältst du zunächst ein kurzes <b>Szenario</b>, in das du dich
                reinversetzen sollst. Zum Abschluss jedes Wegabschnitts erhältst
                du ein kurzes <b>Feedback</b>.
              </p>
            </div>
          )}
          <div>
            <div
              ...
              <p className="w-7/12">
                Der <b>Fortschrittsbalken</b> zeigt an, wie weit du jeweils in
                den drei Themenabschnitten <b className="pink">{topics[0]}</b>,{" "}
                <b className="lila">{topics[1]}</b> und{" "}
                <b className="türkis">{topics[2]}</b> fortgeschritten bist. Die
                dunklere Farbe zeigt, wieviele der Fragen du <b>korrekt</b>{" "}
                beantwortet hast.
              </p>
            </div>
            <div className="flex row justify-between items-center mr-5 ml-5">
              ...
              <p className="w-7/12">
                ...
                <b>Frage tauschen</b> oder einen <b>Tipp erhalten</b> kannst. Du
                kannst bei jeder Aufgabe genau <b>einen Joker</b> einsetzen. In
                der Quiz-Übersicht siehst du, bei welchen Fragen du Joker
                verwendet hast.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="w-9/12 mt-8">
              <p className="pb-3">
                ...
                <b className="pink">{topics[0]}</b>,{" "}
                <b className="lila">{topics[1]}</b> und{" "}
                <b className="türkis">{topics[2]}</b> testen.
              </p>
              <p>
                Zu jedem Thema erhältst du zunächst ein kurzes <b>Szenario</b>,
                in das du dich reinversetzen sollst. Zum Abschluss jedes
                Wegabschnitts erhältst du ein kurzes <b>Feedback</b>.
              </p>
            </div>
          </div>
          <div className="img-container self-end mr-4">
