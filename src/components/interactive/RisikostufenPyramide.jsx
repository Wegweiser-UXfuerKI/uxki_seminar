    ...
    <div
      ...
      <div className="w-full absolute top-[25%] bottom-[50%] z-30">
        ...
        <div
          ...
          <p className="p-[8px] text-right mb-0">
            ...
            medizinische Geräte, sowie b) KI-Systeme in sonstigen spezifischen
            Bereichen: z.B. biometrische Identifizierung von natürlichen
            Personen, allgemeine und berufliche Bildung und Strafverfolgung. Der
      ...
      <div className="w-full absolute top-[50%] bottom-[25%] z-20">
        ...
        <div
          ...
          <p className="p-[8px] text-end mb-0">
            ...
            ausweisen, Gestaltung der KI derart, dass keine illegale Inhalte
