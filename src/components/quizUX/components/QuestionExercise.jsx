...
const QuestionExercise = ({ exercise, onAnswer, answerUser = null }) => {
  ...
  const handleAnswerHover = (answerBox) => {
    isClickable && setHovered(answerBox);
  };
  // resets hovered answer
  const handleAnswerLeave = () => {
    isClickable && setHovered("");
  };
