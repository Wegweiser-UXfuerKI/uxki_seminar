    ...
    switch (exercise.type) {
      case "question":
        ...
        return (
          <div className="flex flex-col ml-8 mr-8">
            <div style={{ ...question_style, background: color }}>
              {exercise.question}
            </div>
      ...
      case "match":
        ...
        return (
          <div className="flex flex-col ml-8 mr-8">
            <div
              className="font-semibold mb-3 rounded-lg p-3 text-center"
      ...
      case "sort":
        ...
        const items = exercise.belongsInFirst
          .split(";")
          .concat(exercise.belongsInSecond.split(";"));
        shuffleArray(items);

        return (
          <div className="flex flex-col ml-8 mr-8">
            <div
              className="font-semibold mb-4 rounded-lg p-3"
              style={{ background: color }}>
              {exercise.question}
            </div>
                ...
                <div
                  ...
                  <div className="flex row">
                    <div
                      style={{
                        ...button_style,
                        background: exercise.belongsInFirst.includes(item)
                          ? colors.correct
                          : colors.lightgrey,
                      }}>
                      {firstCategory}
                    ...
                    <div
                      style={{
                        ...button_style,
                        background: exercise.belongsInSecond.includes(item)
                          ? colors.correct
                          : colors.lightgrey,
                      }}>
                      {secondCategory}
    ...
    <div className="flex flex-col cursor-default h-full w-full ml-4 mr-4 justify-between">
      ...
      <div className="flex row justify-between items-end justify-self-end">
        ...
        <div className="flex w-1/3 justify-end">
          <h5>
            {allExercises.indexOf(exercise) + 1}/{allExercises.length}
          </h5>
        </div>
      </div>
    </div>
